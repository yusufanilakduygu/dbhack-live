...
# TNS Header
    ...
    try:
        ...
        print('  Not Connected to the port for SID test')
        print('')
        sock.close()
        return
    print('  Connected to the port')	
    ...
    if msg == correct_returned_message:
        print ('   '+p_sid+' services on this server as SID')
    else:
...
# TNS Header
    ...
    try:
        ...
        print('  Not Connected to the port for SERVICE_NAME test')
        print('')
        sock.close()
        return
    ...
    msg = sock.recv(2048)
    if msg == correct_returned_message:
        print ('   '+p_sid+' services on this server as SERVICE_NAME')
    else:
